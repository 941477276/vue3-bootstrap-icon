...
export interface BsiEmojiKissType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiEmojiKiss: BsiEmojiKissType = function (props, ctx) {
