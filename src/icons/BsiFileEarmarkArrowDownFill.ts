...
export interface BsiFileEarmarkArrowDownFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiFileEarmarkArrowDownFill: BsiFileEarmarkArrowDownFillType = function (props, ctx) {
