...
export interface BsiDatabaseExclamationType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiDatabaseExclamation: BsiDatabaseExclamationType = function (props, ctx) {
