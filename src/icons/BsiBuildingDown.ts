...
export interface BsiBuildingDownType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiBuildingDown: BsiBuildingDownType = function (props, ctx) {
...
export default BsiBuildingDown;
export { BsiBuildingDown };