...
export interface BsiFiletypeYmlType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiFiletypeYml: BsiFiletypeYmlType = function (props, ctx) {
...
export default BsiFiletypeYml;
export { BsiFiletypeYml };