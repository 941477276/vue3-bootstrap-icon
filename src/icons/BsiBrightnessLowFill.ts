...
export interface BsiBrightnessLowFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiBrightnessLowFill: BsiBrightnessLowFillType = function (props, ctx) {
