...
export interface BsiCcCircleType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiCcCircle: BsiCcCircleType = function (props, ctx) {
