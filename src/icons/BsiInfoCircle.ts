...
export interface BsiInfoCircleType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiInfoCircle: BsiInfoCircleType = function (props, ctx) {
...
export default BsiInfoCircle;
export { BsiInfoCircle };