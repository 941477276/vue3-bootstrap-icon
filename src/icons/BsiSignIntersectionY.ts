...
export interface BsiSignIntersectionYType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiSignIntersectionY: BsiSignIntersectionYType = function (props, ctx) {
