...
export interface BsiJournalBookmarkType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiJournalBookmark: BsiJournalBookmarkType = function (props, ctx) {
