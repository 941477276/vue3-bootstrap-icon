...
export interface BsiFileEarmarkZipType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiFileEarmarkZip: BsiFileEarmarkZipType = function (props, ctx) {
...
export default BsiFileEarmarkZip;
export { BsiFileEarmarkZip };