...
export interface BsiCartCheckType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiCartCheck: BsiCartCheckType = function (props, ctx) {
