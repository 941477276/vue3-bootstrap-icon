...
export interface BsiCalendarDateType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiCalendarDate: BsiCalendarDateType = function (props, ctx) {
...
export default BsiCalendarDate;
export { BsiCalendarDate };