...
export interface BsiBellFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiBellFill: BsiBellFillType = function (props, ctx) {
