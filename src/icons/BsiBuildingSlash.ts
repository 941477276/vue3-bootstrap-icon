...
export interface BsiBuildingSlashType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiBuildingSlash: BsiBuildingSlashType = function (props, ctx) {
  return createVNode(BsIcon, {
    ...props,
    // ...ctx.attrs,
    iconName: 'building-slash',
    isFilled: false,
...
BsiBuildingSlash.displayName = 'BsiBuildingSlash';
export default BsiBuildingSlash;
export { BsiBuildingSlash };