...
export interface BsiCcSquareType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiCcSquare: BsiCcSquareType = function (props, ctx) {
