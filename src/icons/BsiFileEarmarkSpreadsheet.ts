...
export interface BsiFileEarmarkSpreadsheetType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiFileEarmarkSpreadsheet: BsiFileEarmarkSpreadsheetType = function (props, ctx) {
