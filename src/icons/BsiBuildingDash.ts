...
export interface BsiBuildingDashType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiBuildingDash: BsiBuildingDashType = function (props, ctx) {
...
export default BsiBuildingDash;
export { BsiBuildingDash };