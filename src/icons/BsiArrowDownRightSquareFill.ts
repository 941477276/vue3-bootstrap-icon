...
export interface BsiArrowDownRightSquareFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiArrowDownRightSquareFill: BsiArrowDownRightSquareFillType = function (props, ctx) {
