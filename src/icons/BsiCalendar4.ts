...
export interface BsiCalendar4Type extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiCalendar4: BsiCalendar4Type = function (props, ctx) {
