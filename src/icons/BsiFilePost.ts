...
export interface BsiFilePostType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiFilePost: BsiFilePostType = function (props, ctx) {
