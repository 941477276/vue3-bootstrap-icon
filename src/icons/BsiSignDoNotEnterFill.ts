...
export interface BsiSignDoNotEnterFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiSignDoNotEnterFill: BsiSignDoNotEnterFillType = function (props, ctx) {
...
export default BsiSignDoNotEnterFill;
export { BsiSignDoNotEnterFill };