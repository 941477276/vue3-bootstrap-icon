...
export interface BsiEnvelopeExclamationFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiEnvelopeExclamationFill: BsiEnvelopeExclamationFillType = function (props, ctx) {
