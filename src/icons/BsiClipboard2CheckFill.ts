...
export interface BsiClipboard2CheckFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiClipboard2CheckFill: BsiClipboard2CheckFillType = function (props, ctx) {
