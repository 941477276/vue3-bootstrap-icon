...
export interface BsiCloudSleetType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiCloudSleet: BsiCloudSleetType = function (props, ctx) {
