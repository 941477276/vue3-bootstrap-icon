...
export interface BsiFiletypeMp4Type extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiFiletypeMp4: BsiFiletypeMp4Type = function (props, ctx) {
...
export default BsiFiletypeMp4;
export { BsiFiletypeMp4 };