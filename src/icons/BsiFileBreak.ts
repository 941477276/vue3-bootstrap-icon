...
export interface BsiFileBreakType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiFileBreak: BsiFileBreakType = function (props, ctx) {
