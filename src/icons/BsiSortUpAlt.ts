...
export interface BsiSortUpAltType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiSortUpAlt: BsiSortUpAltType = function (props, ctx) {
