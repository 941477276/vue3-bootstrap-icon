...
export interface BsiDashSquareType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiDashSquare: BsiDashSquareType = function (props, ctx) {
...
export default BsiDashSquare;
export { BsiDashSquare };