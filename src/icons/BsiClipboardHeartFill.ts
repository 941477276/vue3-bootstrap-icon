...
export interface BsiClipboardHeartFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiClipboardHeartFill: BsiClipboardHeartFillType = function (props, ctx) {
