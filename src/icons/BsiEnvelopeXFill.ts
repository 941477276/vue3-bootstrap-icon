...
export interface BsiEnvelopeXFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiEnvelopeXFill: BsiEnvelopeXFillType = function (props, ctx) {
...
export default BsiEnvelopeXFill;
export { BsiEnvelopeXFill };