...
export interface BsiTrainLightrailFrontType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiTrainLightrailFront: BsiTrainLightrailFrontType = function (props, ctx) {
