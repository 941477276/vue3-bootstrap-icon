...
export interface BsiBuildingAddType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiBuildingAdd: BsiBuildingAddType = function (props, ctx) {
  return createVNode(BsIcon, {
    ...props,
    // ...ctx.attrs,
    iconName: 'building-add',
    isFilled: false,
...
BsiBuildingAdd.displayName = 'BsiBuildingAdd';
export default BsiBuildingAdd;
export { BsiBuildingAdd };