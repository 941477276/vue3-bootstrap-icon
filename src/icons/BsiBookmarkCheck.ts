...
export interface BsiBookmarkCheckType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiBookmarkCheck: BsiBookmarkCheckType = function (props, ctx) {
