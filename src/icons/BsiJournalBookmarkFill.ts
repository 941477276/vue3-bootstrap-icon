...
export interface BsiJournalBookmarkFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiJournalBookmarkFill: BsiJournalBookmarkFillType = function (props, ctx) {
