...
export interface BsiBagCheckType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiBagCheck: BsiBagCheckType = function (props, ctx) {
