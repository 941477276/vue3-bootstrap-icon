...
export interface BsiCalendar2Type extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiCalendar2: BsiCalendar2Type = function (props, ctx) {
