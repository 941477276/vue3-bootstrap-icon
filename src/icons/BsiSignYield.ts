...
export interface BsiSignYieldType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiSignYield: BsiSignYieldType = function (props, ctx) {
