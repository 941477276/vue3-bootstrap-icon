...
export interface BsiTelephoneType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiTelephone: BsiTelephoneType = function (props, ctx) {
