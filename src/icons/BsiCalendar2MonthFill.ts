...
export interface BsiCalendar2MonthFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiCalendar2MonthFill: BsiCalendar2MonthFillType = function (props, ctx) {
