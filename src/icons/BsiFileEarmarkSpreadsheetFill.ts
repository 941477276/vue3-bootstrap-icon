...
export interface BsiFileEarmarkSpreadsheetFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiFileEarmarkSpreadsheetFill: BsiFileEarmarkSpreadsheetFillType = function (props, ctx) {
