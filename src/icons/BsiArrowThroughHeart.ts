...
export interface BsiArrowThroughHeartType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiArrowThroughHeart: BsiArrowThroughHeartType = function (props, ctx) {
...
export default BsiArrowThroughHeart;
export { BsiArrowThroughHeart };