...
export interface BsiPersonUpType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiPersonUp: BsiPersonUpType = function (props, ctx) {
