...
export interface BsiSignMergeRightFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiSignMergeRightFill: BsiSignMergeRightFillType = function (props, ctx) {
