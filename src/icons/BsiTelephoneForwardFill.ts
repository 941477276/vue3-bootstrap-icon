...
export interface BsiTelephoneForwardFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiTelephoneForwardFill: BsiTelephoneForwardFillType = function (props, ctx) {
