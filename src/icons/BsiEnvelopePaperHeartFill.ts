...
export interface BsiEnvelopePaperHeartFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiEnvelopePaperHeartFill: BsiEnvelopePaperHeartFillType = function (props, ctx) {
