...
export interface BsiBackspaceReverseFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiBackspaceReverseFill: BsiBackspaceReverseFillType = function (props, ctx) {
