...
export interface BsiCodeSlashType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiCodeSlash: BsiCodeSlashType = function (props, ctx) {
