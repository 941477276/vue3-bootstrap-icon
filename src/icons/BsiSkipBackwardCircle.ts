...
export interface BsiSkipBackwardCircleType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiSkipBackwardCircle: BsiSkipBackwardCircleType = function (props, ctx) {
