...
export interface BsiClipboardType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiClipboard: BsiClipboardType = function (props, ctx) {
...
BsiClipboard.displayName = 'BsiClipboard';
export default BsiClipboard;
export { BsiClipboard };