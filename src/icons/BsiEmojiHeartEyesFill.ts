...
export interface BsiEmojiHeartEyesFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiEmojiHeartEyesFill: BsiEmojiHeartEyesFillType = function (props, ctx) {
