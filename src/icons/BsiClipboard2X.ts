...
export interface BsiClipboard2XType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiClipboard2X: BsiClipboard2XType = function (props, ctx) {
...
export default BsiClipboard2X;
export { BsiClipboard2X };