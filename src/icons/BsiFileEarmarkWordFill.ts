...
export interface BsiFileEarmarkWordFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiFileEarmarkWordFill: BsiFileEarmarkWordFillType = function (props, ctx) {
