...
export interface BsiTrainLightrailFrontFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiTrainLightrailFrontFill: BsiTrainLightrailFrontFillType = function (props, ctx) {
