...
export interface BsiFuelPumpDieselFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiFuelPumpDieselFill: BsiFuelPumpDieselFillType = function (props, ctx) {
