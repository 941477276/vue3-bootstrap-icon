...
export interface BsiInfoSquareType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiInfoSquare: BsiInfoSquareType = function (props, ctx) {
...
BsiInfoSquare.displayName = 'BsiInfoSquare';
export default BsiInfoSquare;
export { BsiInfoSquare };