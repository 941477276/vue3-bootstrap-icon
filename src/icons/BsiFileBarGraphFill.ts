...
export interface BsiFileBarGraphFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiFileBarGraphFill: BsiFileBarGraphFillType = function (props, ctx) {
...
export default BsiFileBarGraphFill;
export { BsiFileBarGraphFill };