...
export interface BsiVectorPenType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiVectorPen: BsiVectorPenType = function (props, ctx) {
