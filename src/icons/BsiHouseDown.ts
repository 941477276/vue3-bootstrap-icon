...
export interface BsiHouseDownType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiHouseDown: BsiHouseDownType = function (props, ctx) {
