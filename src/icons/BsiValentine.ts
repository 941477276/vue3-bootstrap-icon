...
export interface BsiValentineType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiValentine: BsiValentineType = function (props, ctx) {
