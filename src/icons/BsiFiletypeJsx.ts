...
export interface BsiFiletypeJsxType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiFiletypeJsx: BsiFiletypeJsxType = function (props, ctx) {
...
export default BsiFiletypeJsx;
export { BsiFiletypeJsx };