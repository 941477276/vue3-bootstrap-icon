...
export interface BsiEnvelopeXType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiEnvelopeX: BsiEnvelopeXType = function (props, ctx) {
...
BsiEnvelopeX.displayName = 'BsiEnvelopeX';
export default BsiEnvelopeX;
export { BsiEnvelopeX };