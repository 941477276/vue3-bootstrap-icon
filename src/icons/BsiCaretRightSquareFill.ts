...
export interface BsiCaretRightSquareFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiCaretRightSquareFill: BsiCaretRightSquareFillType = function (props, ctx) {
