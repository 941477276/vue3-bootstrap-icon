...
export interface BsiClipboard2HeartFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiClipboard2HeartFill: BsiClipboard2HeartFillType = function (props, ctx) {
...
export default BsiClipboard2HeartFill;
export { BsiClipboard2HeartFill };