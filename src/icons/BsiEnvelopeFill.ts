...
export interface BsiEnvelopeFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiEnvelopeFill: BsiEnvelopeFillType = function (props, ctx) {
...
export default BsiEnvelopeFill;
export { BsiEnvelopeFill };