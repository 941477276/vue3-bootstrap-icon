...
export interface BsiClipboardPlusFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiClipboardPlusFill: BsiClipboardPlusFillType = function (props, ctx) {
