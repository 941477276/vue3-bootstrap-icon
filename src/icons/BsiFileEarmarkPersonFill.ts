...
export interface BsiFileEarmarkPersonFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiFileEarmarkPersonFill: BsiFileEarmarkPersonFillType = function (props, ctx) {
