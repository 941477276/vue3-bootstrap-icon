...
export interface BsiImageFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiImageFill: BsiImageFillType = function (props, ctx) {
