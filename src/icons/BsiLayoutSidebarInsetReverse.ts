...
export interface BsiLayoutSidebarInsetReverseType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiLayoutSidebarInsetReverse: BsiLayoutSidebarInsetReverseType = function (props, ctx) {
