...
export interface BsiFileEarmarkTextType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiFileEarmarkText: BsiFileEarmarkTextType = function (props, ctx) {
...
export default BsiFileEarmarkText;
export { BsiFileEarmarkText };