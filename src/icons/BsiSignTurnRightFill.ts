...
export interface BsiSignTurnRightFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiSignTurnRightFill: BsiSignTurnRightFillType = function (props, ctx) {
...
export default BsiSignTurnRightFill;
export { BsiSignTurnRightFill };