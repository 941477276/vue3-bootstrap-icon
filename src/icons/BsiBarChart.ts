...
export interface BsiBarChartType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiBarChart: BsiBarChartType = function (props, ctx) {
