...
export interface BsiEnvelopeSlashFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiEnvelopeSlashFill: BsiEnvelopeSlashFillType = function (props, ctx) {
