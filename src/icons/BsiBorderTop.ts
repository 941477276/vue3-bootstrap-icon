...
export interface BsiBorderTopType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiBorderTop: BsiBorderTopType = function (props, ctx) {
