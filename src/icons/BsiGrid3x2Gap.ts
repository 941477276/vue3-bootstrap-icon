...
export interface BsiGrid3x2GapType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiGrid3x2Gap: BsiGrid3x2GapType = function (props, ctx) {
...
export default BsiGrid3x2Gap;
export { BsiGrid3x2Gap };