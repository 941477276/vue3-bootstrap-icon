...
export interface BsiProjectorType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiProjector: BsiProjectorType = function (props, ctx) {
