...
export interface BsiFileLock2Type extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiFileLock2: BsiFileLock2Type = function (props, ctx) {
