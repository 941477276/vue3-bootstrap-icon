...
export interface BsiBookmarkHeartFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiBookmarkHeartFill: BsiBookmarkHeartFillType = function (props, ctx) {
