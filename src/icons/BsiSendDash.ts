...
export interface BsiSendDashType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiSendDash: BsiSendDashType = function (props, ctx) {
