...
export interface BsiChatLeftQuoteType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiChatLeftQuote: BsiChatLeftQuoteType = function (props, ctx) {
  return createVNode(BsIcon, {
    ...props,
    // ...ctx.attrs,
    iconName: 'chat-left-quote',
    isFilled: false,
...
BsiChatLeftQuote.displayName = 'BsiChatLeftQuote';
export default BsiChatLeftQuote;
export { BsiChatLeftQuote };