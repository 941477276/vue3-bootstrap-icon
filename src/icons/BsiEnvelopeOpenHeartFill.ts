...
export interface BsiEnvelopeOpenHeartFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiEnvelopeOpenHeartFill: BsiEnvelopeOpenHeartFillType = function (props, ctx) {
