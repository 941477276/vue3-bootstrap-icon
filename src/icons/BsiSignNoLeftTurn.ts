...
export interface BsiSignNoLeftTurnType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiSignNoLeftTurn: BsiSignNoLeftTurnType = function (props, ctx) {
...
export default BsiSignNoLeftTurn;
export { BsiSignNoLeftTurn };