...
export interface BsiFiletypePptType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiFiletypePpt: BsiFiletypePptType = function (props, ctx) {
...
export default BsiFiletypePpt;
export { BsiFiletypePpt };