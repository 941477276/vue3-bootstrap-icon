...
var BsiThermometerHalf_exports = {};
__export(BsiThermometerHalf_exports, {
  BsiThermometerHalf: () => BsiThermometerHalf,
  default: () => BsiThermometerHalf_default
});
module.exports = __toCommonJS(BsiThermometerHalf_exports);
