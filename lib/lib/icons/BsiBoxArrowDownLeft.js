...
var BsiBoxArrowDownLeft_exports = {};
__export(BsiBoxArrowDownLeft_exports, {
  BsiBoxArrowDownLeft: () => BsiBoxArrowDownLeft,
  default: () => BsiBoxArrowDownLeft_default
});
module.exports = __toCommonJS(BsiBoxArrowDownLeft_exports);
