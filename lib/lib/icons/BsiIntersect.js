...
var BsiIntersect_exports = {};
__export(BsiIntersect_exports, {
  BsiIntersect: () => BsiIntersect,
  default: () => BsiIntersect_default
});
module.exports = __toCommonJS(BsiIntersect_exports);
