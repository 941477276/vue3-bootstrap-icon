...
var BsiChevronBarUp_exports = {};
__export(BsiChevronBarUp_exports, {
  BsiChevronBarUp: () => BsiChevronBarUp,
  default: () => BsiChevronBarUp_default
});
module.exports = __toCommonJS(BsiChevronBarUp_exports);
