...
var BsiDoorClosed_exports = {};
__export(BsiDoorClosed_exports, {
  BsiDoorClosed: () => BsiDoorClosed,
  default: () => BsiDoorClosed_default
});
module.exports = __toCommonJS(BsiDoorClosed_exports);
