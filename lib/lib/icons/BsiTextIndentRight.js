...
var BsiTextIndentRight_exports = {};
__export(BsiTextIndentRight_exports, {
  BsiTextIndentRight: () => BsiTextIndentRight,
  default: () => BsiTextIndentRight_default
});
module.exports = __toCommonJS(BsiTextIndentRight_exports);
