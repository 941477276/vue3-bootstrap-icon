...
// src/icons/BsiChatSquareHeart.ts
var BsiChatSquareHeart_exports = {};
__export(BsiChatSquareHeart_exports, {
  BsiChatSquareHeart: () => BsiChatSquareHeart,
  default: () => BsiChatSquareHeart_default
});
module.exports = __toCommonJS(BsiChatSquareHeart_exports);
var import_vue = require("vue");
var import_BsIcon = __toESM(require("../components/BsIcon"));
var BsiChatSquareHeart = function(props, ctx) {
  return (0, import_vue.createVNode)(import_BsIcon.default, {
    ...props,
    iconName: "chat-square-heart",
    isFilled: false,
...
BsiChatSquareHeart.displayName = "BsiChatSquareHeart";
var BsiChatSquareHeart_default = BsiChatSquareHeart;
